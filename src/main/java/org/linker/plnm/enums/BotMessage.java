...
public enum BotMessage {
    ...
    TASK_ALREADY_EXIST("❌ Task %s already exists!"),
    ...
    TEAM_TASK_CREATED("✅ task '%s' has been successfully created for team '%s'."),
    TEAM_TASK_REMOVED("✅ task '%s' has been successfully removed for team '%s'."),
    TASK_UPDATED("✅ task '%s' has been successfully updated."),
    TASK_DOES_NOT_EXIST("❌ task '%s' does not exist."),
    TEAM_TASK_ALREADY_EXISTS("❌ task '%s' already exist for team '%s'."),
    ...
    ASK_TASKS_TO_ADD(IOUtilities.readFile("static/tasks_to_add.html")),
    ASK_TASKS_TO_REMOVE(IOUtilities.readFile("static/tasks_to_remove.html")),
    ASK_TASKS_TO_CHANGE_STATUS(IOUtilities.readFile("static/tasks_to_update.html")),
